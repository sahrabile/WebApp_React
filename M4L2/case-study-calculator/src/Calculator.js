  ...
  render() {
    ...
    return <div className="calculator-container">
      <div className="calculator-grid">
        ...
        <button data-oper="sqr" className="science">sqr</button>
        <button data-oper="MCl" className="science">MC</button>
        <button data-oper="MSt" className="science">MSt</button>
        <button data-oper="MRe" className="science" style={{ backgroundColor: 'green' }}>MRe</button>
...
/* Exercises
  1. Modify code to generate two calculators in the App. Try them to verify they work independently
  2. Implement the sqr operation. Sqr = currentOperand * current Operans. 
  3. Implement the MSt, MRe, MC buttons.
  ...
  4. Indicate MRe as green background only when memOperand has a value (to indicated MRe can be used)
*/